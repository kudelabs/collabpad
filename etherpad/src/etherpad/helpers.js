...
function includeJQuery() {
  if (!_hd().includeJQueryJs) {
    if (isProduction()) {
      ...
      addToHead('<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/1.7.2/jquery.min.js" type="text/javascript"></script>');
    } else {
...
function facebookOpenGraphMetadata(pageArgs) {
  ...
  addToHead('<meta property="og:image" content="https://collab.cool/static/img/hackpad-logo.png" />');
...
function addDefaultMetadata() {
  addToHead("<meta content='collab.cool' name='title' />");
