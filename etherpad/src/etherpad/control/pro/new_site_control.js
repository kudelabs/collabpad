...
function render_step1Post_post() {
  ...
  if (!newSiteData.defaultWelcomeEmailSubject) {
    ...
    newSiteData.defaultWelcomeEmailSubject += " invited you to " + newSiteData.shortName + ".collab.cool";
  }
  if (!newSiteData.defaultWelcomeEmailBody) {
    newSiteData.defaultWelcomeEmailBody = "Come and hack with me: https://" + newSiteData.shortName + ".collab.cool/\n\n";
